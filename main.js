...
date.addEventListener('input', function(e) {
        ...
        // show error if is not valid date
...
function isNotDate(element) {
        ...
        if(element.value === '' || monthNumber < 1 || monthNumber > 12 || yearNumber < year || (monthNumber <=
        month && yearNumber === year )); {
               return true;
        } else {
                return false;
        }   
...
form.addEventListener('submit', function (e) {
        ...
        // 3. if is not validdate (4 numbers and "/" or is not a valid date)
